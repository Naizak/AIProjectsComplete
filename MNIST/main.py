...
# for example if we want to create a Network object with
...
# This random initialization gives our stochastic gradient descent algorithm
...
class Network(object):
    ...
    # which updates the network weights and biases according to a
    # single iteration of gradient descent, using just the training data in mini_batch.
